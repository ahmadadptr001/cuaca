    ...
    return (
        ...
        >
            ...
            >
                ...
                {/* content */}
                <div className="grid grid-cols-1 z-4 h-full group-hover:delay-400 border group-focus-within:opacity-100 opacity-0 duration-500 group-hover:opacity-100 text-white group-hover:text-warning">
                    <div></div>
                    <div></div>
